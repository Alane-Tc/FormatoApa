window.addEventListener("load", function () {
    ...
    function Apa() {
        if (va1.value != "" && va2.value != "" && va3.value != "" && va4.value != "" && va5.value != "" && va6.value != "" && va7.value != "") {
            show();
            format.innerHTML = ("Cópiala y pégala en tu documento.<br />   " + va1.value + ". (" + va2.value + "). " + va3.value + '. En ' + va4.value + "(" + va5.value + "). " + va6.value + ": " + va7.value + ". ");
        } else {
